...
import "./gamezoonheader.css";


const HeaderGameZone: React.FC = () => {
                    ...
                    <div className='row g-0 w-100' style={{ alignItems: 'center' }}>
                        <div className='col-lg-3 col-md-4'>
                            <a className="navbar-brand" href="#" style={{ display: 'flex', alignItems: 'center' }}>
                                <img src="./images/player.png" className='player' alt=""></img>
                                <p className='ply-name'>{joinersName}</p>
                            </a>
                        </div>
                                            ...
                                            <div className="form-row">
                                                {isConnected ?
                                                    <div className="input-group form-group">
                                                        <input type="text" value={address ? `${address.slice(0, 6).concat(`...${address.slice(-4)}`)}` : ""} className="form-control border-radius" style={{ background: '#061B4C', padding: '10px 20px' }} />
                                                    ...
                                                    //     // <div className="'wallet-btn'" key={connector.id}>
